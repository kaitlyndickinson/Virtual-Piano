...
namespace GUI_Virtual_Piano
{
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            App.selectedTheme = 1; // Dark theme is default
            loadCurrentlySelectedSampleLibrary("Piano");    // Could Be Piano, Drums, or Bell
            setLabeledPianoKeys("Yes");                      // Sending "Yes" means show labels, "No" means hide labels
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                setLabeledPianoKeys(App.areKeysLabeled);
            }
        }
